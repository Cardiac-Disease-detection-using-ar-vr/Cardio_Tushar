...
\begin{frame}{Problem Statement \& Contributions}
  ...
  \quad Accuracy = 98.05\% \quad ECE = 0.0041 \quad 45/45 tests passed}}
\end{frame}
...
\begin{frame}{Quantitative Results -- Holdout Test Set ($n=1{,}026$)}
  ...
  \begin{tabular}{@{}lcc@{}}
    ...
    Classification Accuracy          & \textbf{98.05\%} & $>90\%$ \\
    Precision (PPV)                  & 78.90\%  & -- \\
    Recall (Sensitivity)             & 94.22\%  & -- \\
    F1-Score                         & 91.01\%  & -- \\
    Cohen's Kappa ($\kappa$)         & 0.9083   & $>0.60$ \\
    Specificity                      & 99.04\%  & -- \\
  ...
  \begin{columns}[T]
    \column{0.52\textwidth}
      ...
      \begin{tabular}{@{}lccccc@{}}
        ...
        \midrule
        Low Risk (0)  & 98.25\% & 99.04\% & 97.87\% & 924 & +0.73 \\
        High Risk (1) & 78.90\% & 94.22\% & 91.01\% & 102 & +0.73 \\
        \midrule
        Weighted avg  & 96.57\% & 98.05\% & 96.37\% & 1026 & -- \\
    ...
    \column{0.46\textwidth}
      \textbf{Observations:}
      \begin{itemize}\small
        \item Low-risk class: precision 98.25\% and recall 99.04\%
              -- almost perfect identification of non-events.
        \item High-risk class: F1 91.01\% despite 10:1 imbalance
  ...
  \begin{columns}[T]
    \column{0.50\textwidth}
      ...
      \begin{tabular}{@{}lcc@{}}
        ...
        Accuracy         & \textbf{98.05\%} & $>90\%$ \checkmark \\
        Sensitivity      & 94.22\%  & $>80\%$ \checkmark \\
        Specificity      & 99.04\%  & $>95\%$ \checkmark \\
        F1-Score         & 91.01\%  & $>75\%$ \checkmark \\
        Cohen's $\kappa$ & 0.9083   & $>0.60$ \checkmark \\
  ...
  \begin{columns}[T]
    \column{0.50\textwidth}
      ...
      \begin{tabular}{@{}lccc@{}}
        ...
        \midrule
        \textbf{True Low}  & \textbf{821} & 13 & 1 \\
        \textbf{True Mild} & 2 & \textbf{86} & 1 \\
        \textbf{True High} & 1 & 2 & \textbf{99} \\
        \bottomrule
      \end{tabular}
      \end{center}
      \vspace{0.3em}
      ...
      \begin{itemize}\scriptsize
        \item Overall Accuracy = \textbf{98.05\%}
        \item Cohen's Kappa = \textbf{0.9083} (Excellent)
        \item Macro Sensitivity = \textbf{94.22\%}
        \item Macro Specificity = \textbf{99.04\%}
        \item Macro F1-Score = \textbf{91.01\%}
      \end{itemize}
    \column{0.50\textwidth}
...
\begin{frame}{Comparison with Baseline Methods}
  ...
  \begin{tabular}{@{}p{4.2cm}cccc@{}}
    ...
    \textbf{Proposed (DS+ISO)} & \textbf{0.9868} & \textbf{98.05\%}
